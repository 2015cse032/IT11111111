<html>
<head><title> CLOSE LOOP| TOPICS</title></head>
<body>
<?php
...
<table width="400" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
<tr>
<form method="post" action="add_answer.php"><!---the add_answer html code---->
<td>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
<tr>
<td width="18%"><strong>Name</strong></td>
<td width="3%">:</td>
<td width="79%"><input type="text" name="a_name" type="text" id="a_name" size="45"></td>
</tr>
<tr>
<td><strong>Email</strong></td>
<td>:</td>
<td><input type="text" name="a_email" type="text" id="a_email" size="45"></td>
</tr>
<tr>
<td valign="top"><strong>Answer</strong></td>
<td valign="top">:</td>
<td><textarea name="a_answer" cols="100" rows="10"></textarea></td>
</tr>
<tr>
<td>&nbsp;</td>
<td><input type="number" name="id" type="hidden" value="<?php echo $id; ?>"></td>
